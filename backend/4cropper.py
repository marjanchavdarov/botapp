"""
katalog.ai — Cropper Tool (standalone) - COMPLETE VERSION
Includes: Cropper, Annotator, and Validator tools
"""
...
<div class="header">
  ...
  <div class="nav-links">
    <a href="/">Cropper</a>
    <a href="/annotate">Annotator</a>
    <a href="/validate" class="active">Validator</a>
  </div>
</div>
...
function renderCatalogues() {
  ...
  grid.innerHTML = allCatalogues.map(cat => {
    const goodPct = cat.feedback && cat.feedback.total ? Math.round(cat.feedback.good / cat.feedback.total * 100) : 0;
    ...
    return `
      <div class="catalogue-card">
        ...
        ${cat.feedback && cat.feedback.total ? `
